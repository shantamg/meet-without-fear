...
Read the manual tester skill for persona and gold-flow behavior:

- `/Users/shantam/.codex/skills/mwf-gold-session-tester/SKILL.md`
- `/Users/shantam/.codex/skills/mwf-gold-session-tester/references/gold-personas.md`
